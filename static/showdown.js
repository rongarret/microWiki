...
// Wikilinks
//
function canonicalize_wikilink(link) {
...
function format_td(s) {
  if (s[0]=="+") return tag("TH", s.slice(1))
  else return tag("TD", s)
}

function format_tr(s) {
  return tag("TR", s)
}
...
function process_tables(text) {
  text = text.replace(table1_re, format_table1)
